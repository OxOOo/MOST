#ifndef __AM2FAST_H__
#define __AM2FAST_H__
...
public:
    ...
    __int128_t M;
    __int128_t __attribute__((aligned(64))) pow10[N + MAX_APPEND];
    __int128_t __attribute__((aligned(64))) pow10inv[N + MAX_APPEND];
    __int128_t __attribute__((aligned(64))) num[N]; // 不同长度的后缀
    ...
    __int128_t __attribute__((aligned(64))) appends[MAX_APPEND];
    ...
    {
        __int128_t need1 = 0; // 和前面拼起来
        __int128_t need2 = 0; // 新数据独立产生
